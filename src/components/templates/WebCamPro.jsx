...
const ModalWebcam = (props) => {
  ...
  return (
    <Modal show={showModal} onHide={handleClose} fullscreen="sm-down" className="modal-webcam">
      <div className="modal-content">
        <div className="modal-body">
          <div className="webcam-container">
            ...
            <div className="modal-footer-webcam">
...
const WebcamPro = (props) => {
  ...
  const capture = () => {
    const imageSrc = webcamRef.current.getScreenshot(window.innerWidth);
